  ...
  return (
    <>
      <style>{`
        ...
        .sidebar-logo-icon { font-size: 18px; flex-shrink: 0; width: 24px; text-align: center; color: var(--text-secondary); }
        .sidebar-logo-text { font-size: 14px; font-weight: 700; color: var(--text-secondary); opacity: 0; transition: opacity 0.15s ease; }
        ...
        @media (max-width: 600px) {
          .sidebar {
            width: 100% !important; height: 60px; top: auto; bottom: 0;
            flex-direction: row; padding: 0;
            border-right: none; border-top: 1px solid rgba(255,255,255,0.05);
            align-items: center; justify-content: space-around; transition: none;
          }
          .sidebar-logo { display: none; }
          .sidebar-nav { flex-direction: row; padding: 0; gap: 0; width: 100%; justify-content: space-around; }
          .sidebar-item { flex-direction: column; gap: 2px; padding: 8px 12px; border-radius: 0; align-items: center; }
          .sidebar-label { opacity: 1; font-size: 10px; }
