  ...
  return (
    <>
      ...
      <div className="card" style={{ marginBottom: 22, textAlign: 'center' }}>
        <div style={{ fontSize: 96, fontWeight: 800, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.04em', lineHeight: 1, background: 'linear-gradient(180deg,#fff,#C7C4BC)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: 4 }}>
          {days}
        </div>
